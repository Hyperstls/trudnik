...
## ��������������� (2026-09-04)
- ���� ? ������: ��������� ������� � ����������� ����� ����� ������������; `role_required` ���� �� ���� ������-�������� (admin_required �������). ������ = �������� (`job.employer_id == user_id`) / �������.
- ������� ����: ���� ���������� ����� �������� � �� ����� role_required; �������� �������� (��� invite_worker: check_job_owner).
- `profiles.worker_visibility` (default true): false > ����� �� /workers � �� ������������. ������� = `worker_visibility=eq.true` (�� role=eq.worker).
- �����������: `intent` (both/find_work/post_jobs) > role + worker_visibility; RPC `register_user(p_worker_visibility)`.
- ��������� ����� ��� ���� �����; my-applications � ���� received/sent.
- �����������-������ (invitations/applications) ��������� ��� ���� ����� (context_processors, ��� role-������).
- Docker-dev: templates/static ������������; ������� 24�-��� > ��� ��������� CSS/JS ����� `?v=` � base.html + bump sw.js CACHE_VERSION.

...
-- Все авторизованные пользователи могут читать профили (для отображения трудников)
...
-- Система (через service role key) может вставлять профили при регистрации
...
-- ============================================
-- Дополнительно: настройка RLS для таблицы favorites
-- ============================================
...
-- Пользователи могут добавлять трудников в избранное (с указанием своего user_id)
...
-- Пользователи могут читать свои избранные трудники
...
-- Пользователи могут удалять свои избранные трудники
...
-- ============================================
-- Дополнительно: настройка RLS для таблицы blacklists
-- ============================================
...
-- Пользователи могут добавлять пользователей в чёрный список (с указанием своего user_id)
...
-- Пользователи могут читать свои чёрные списки
...
-- Пользователи могут удалять свои чёрные списки

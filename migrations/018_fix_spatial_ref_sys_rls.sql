...
--
-- ВАЖНО: таблица принадлежит расширению PostGIS, поэтому сначала
-- меняем владельца, потом включаем RLS, потом создаём политику.
-- ============================================================
...
-- который обходит RLS — политика read-only безопасна.
-- ============================================================

-- 1. Сменить владельца (иначе ERROR 42501: must be owner)
ALTER TABLE public.spatial_ref_sys OWNER TO postgres;

-- 2. Включить RLS
ALTER TABLE public.spatial_ref_sys ENABLE ROW LEVEL SECURITY;

-- 3. Read-only политика для аутентифицированных пользователей
DO $$ BEGIN

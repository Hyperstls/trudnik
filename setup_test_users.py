...
TEST_USERS = [
    {"email": "admin@test.ru", "password": "test123456", "role": "admin", "name": "Admin Test"},
    {"email": "org@test.ru", "password": "test123456", "role": "employer", "name": "Org Test"},
    {"email": "trud3@test.ru", "password": "test123456", "role": "worker", "name": "Trud Test"},
]

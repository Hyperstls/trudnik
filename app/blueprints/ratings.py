...
def upsert_rating():
    ...
    job_resp = postgrest_admin_request(
        'GET',
    ...
    if rater_user_id != job['employer_id']:
        ...
        app_check = postgrest_admin_request('GET',
    ...
    if target_type == 'employer':
        ...
        rated_app_check = postgrest_admin_request('GET',
    ...
    if existing.ok and existing.json():
        ...
        resp = postgrest_admin_request('POST', 'ratings', json=rating_data)
        is_new = True
...
def rate_workers_page(job_id):
    ...
    workers_resp = postgrest_request(
        'GET',
    ...
    ratings_resp = postgrest_request(
        'GET',
